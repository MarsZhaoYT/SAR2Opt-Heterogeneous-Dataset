...
if __name__ == '__main__':
    dir_path = 'Image_translation_codes/pytorch-CycleGAN-and-pix2pix/results/sar2opt_pix2pix_A2B/test_latest/images'
    real_path = 'Image_translation_codes/pytorch-CycleGAN-and-pix2pix/results/sar2opt_pix2pix_A2B/test_latest/real'
    fake_path = 'Image_translation_codes/pytorch-CycleGAN-and-pix2pix/results/sar2opt_pix2pix_A2B/test_latest/fake'
